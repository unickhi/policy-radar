...
type LocalStandardHandler struct {
	svc *service.LocalStandardService
}

func NewLocalStandardHandler(svc *service.LocalStandardService) *LocalStandardHandler {
	return &LocalStandardHandler{svc: svc}
}

func (h *LocalStandardHandler) List(c *gin.Context) {
...
func (h *LocalStandardHandler) Get(c *gin.Context) {
...
func (h *LocalStandardHandler) Create(c *gin.Context) {
...
func (h *LocalStandardHandler) Update(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 32)
	if err != nil {
		c.JSON(http.StatusBadRequest, config.Error(400, "ID无效"))
		return
...
func (h *LocalStandardHandler) Delete(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 32)
	if err != nil {
		c.JSON(http.StatusBadRequest, config.Error(400, "ID无效"))
		return
...
func (h *LocalStandardHandler) Check(c *gin.Context) {
	id, err := strconv.ParseUint(c.Param("id"), 10, 32)
	if err != nil {
		c.JSON(http.StatusBadRequest, config.Error(400, "ID无效"))
		return
...
func (h *LocalStandardHandler) Import(c *gin.Context) {
	var items []model.LocalStandard
